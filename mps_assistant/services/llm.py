...
class OpenAIService:
    ...
    def answer_question(
        ...
        instructions = (
            ...
            "\"I don't yet have enough verified information in this assistant's MPS knowledge base to answer that confidently.\" "
            ...
            "Maintain a factual, balanced, and constructive tone about MPS. Do not use disparaging or negative language about MPS. "
        ...
        prompt = (
            ...
            "- Frame uncertainty as a limitation of currently available excerpts, not criticism of MPS.\n"
